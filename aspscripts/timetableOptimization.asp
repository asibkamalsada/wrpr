...
#maximize { X@5,C,N : classTeacherLessons(C, N, X) }.
...
#minimize { X@8,W,C,N : classLessons(W, C, N, X1), classLessonsAverage(C, N, X2), X=|X1-X2| }.
...
#minimize { X@7,T,J : teacherSubjectLessons(T, J, X1), subjectLessonsAverage(J, X2), X=|X1-X2| }.
