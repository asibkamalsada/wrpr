...
0 {re(W,S,X,C,N,J,R) : change(W,S,T,X)} 1 :- timetable(W,S,T,C,N,J,R), findenew(W,S,T).
...
0 {re(W,S,T,C,N,J,X) : changer(W,S,R,X)} 1 :- timetable(W,S,T,C,N,J,R), findenewr(W,S,R).

#maximize { 1@3,W,S,T,C,N,J,R : re(W,S,T,C,N,J,R) }.

% A teacher should in the best case teach the subject he substitutes 
:~ re(W,S,X,C,N,J,R), not teaches(X,J).[1@1,W,S,T]

:~ re(W,S,T,C,N,phy,R), not physRoom(R).[1@2,W,S,R]
:~ re(W,S,T,C,N,chem,R), not chemRoom(R).[1@2,W,S,R]
:~ re(W,S,T,C,N,bio,R), not bioRoom(R).[1@2,W,S,R]
:~ re(W,S,T,C,N,inf,R), not pcRoom(R).[1@2,W,S,R]
:~ re(W,S,T,C,N,mu,R), not musicRoom(R).[1@2,W,S,R]
:~ re(W,S,T,C,N,ku,R), not artRoom(R).[1@2,W,S,R]
:~ re(W,S,T,C,N,spo,R), not gym(R).[1@2,W,S,R]
